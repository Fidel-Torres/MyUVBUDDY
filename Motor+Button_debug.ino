// ============================================================
// MyUVBuddy - Button & Motor Module (Production Ready v4)
// MCU    : Seeed XIAO MG24 (EFR32MG24) - Arduino IDE
// Button : Same Sky TS02 → D10 (10kΩ pull-up)
// Motor  : Vybronics VC1434B002U → 2N2222A → D9
// ============================================================
...
void setup() {
    ...
    Serial.begin(115200);
        ...
        debugPrintMenu();
    #else
        Serial.println("MyUVBuddy - Button & Motor Ready");
    #endif
}
